...
set DECISION_LOG=%ENGINE_DIR%\data\paper_veto_flip_trades.jsonl
set LOG_FILE=%ENGINE_DIR%\data\paper_veto_flip.combined.log
set WATCHDOG_LOG=%ENGINE_DIR%\data\watchdog_paper_veto_flip.log
